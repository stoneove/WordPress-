	...
	<div class="box-content">
		...
		<form method="post" class="woocommerce-ResetPassword lost_reset_password">
			...
			<p class="woocommerce-form-row form-row clearfix">
				...
				<button type="submit" class="woocommerce-Button button btn-lg pt-right" value="<?php esc_attr_e( 'Save', 'woocommerce' ); ?>" value="<?php esc_attr_e( 'Save', 'woocommerce' ); ?>"><?php esc_html_e( 'Save', 'woocommerce' ); ?></button>
			</p>
