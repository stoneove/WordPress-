	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			array(
				...
				'description' => sprintf( __( 'Please leave empty if you want to use default value which is set using WooCommerce -> Product Archives -> Products per Page in %1$sTheme Options%2$s.', 'porto-functionality' ), '<a class="porto-text-underline" href="' . esc_url( admin_url( 'themes.php?page=porto_settings' ) ) . '">', '</a>' ),
				'range'       => array(
					'px' => array(
						'step' => 1,
						'min'  => 1,
