				...
				array(
					...
					'params'      => array(
						...
						array(
							...
							'description' => sprintf( __( 'You can change %1$sglobal%2$s value in theme option.', 'porto-functionality' ), '<a href="' . porto_get_theme_option_url( 'search-cats' ) . '" target="_blank">', '</a>' ),
							'std'         => '',
							'admin_label' => true,
						),
						array(
