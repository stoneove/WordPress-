		...
		$this->start_controls_section(
			...
			$this->add_control(
				...
				array(
					...
					'raw'             => sprintf( esc_html__( 'Please see %1$sTheme Options -> Menu%2$s.', 'porto-functionality' ), '<a href="' . porto_get_theme_option_url( 'menu-type' ) . '" target="_blank">', '</a>' ),
				...
				$this->start_controls_tab(
					...
					$this->add_control(
						...
						array(
							...
							'label'     => __( 'Hover Color', 'porto-functionality' ),
							'selectors' => array(
								'#header .elementor-element-{{ID}} .main-menu > li.menu-item.active > a, #header .elementor-element-{{ID}} .main-menu > li.menu-item:hover > a, .elementor-element-{{ID}} .sidebar-menu > li.menu-item:hover > a, .elementor-element-{{ID}} .sidebar-menu > li.menu-item.active > a' => 'color: {{VALUE}};',
